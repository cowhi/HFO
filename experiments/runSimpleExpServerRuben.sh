...
for I in $(seq 1 1 $2)
do
*HFO exec folder here, example: /home/leno/HFO/bin/HFO* --no-logging --offense-agents=3 --defense-npcs=1 --fullstate --headless --trials=30100 --port=$1 --frames-per-trial=200
done
