...
class AdHocVisit(AdHoc):
    ...
    def __init__(self, budgetAsk=100, budgetAdvise=100,stateImportanceMetric=VISIT_IMPORTANCE,seed=12345, port=12345, epsilon=0.1, alpha=0.1, gamma=0.9, decayRate=0.9):
        super(AdHocVisit, self).__init__(budgetAsk,budgetAdvise,stateImportanceMetric,port = port, seed=seed)
